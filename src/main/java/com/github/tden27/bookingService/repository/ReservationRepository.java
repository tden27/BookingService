...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    Reservation findFirstByResourceAndStartBeforeOrderByStartDesc(Resource resource, LocalDateTime start);

    Reservation findFirstByResourceAndStartAfterOrderByStart(Resource resource, LocalDateTime start);
}
